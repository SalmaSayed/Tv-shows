...
Ref.factory = function(alias, config, more) {
	if (isFunction(alias)) {
		...
		return this.create(_objectSpread({}, config, more, result));
	}

	return this.create(_objectSpread({}, config, more));
};
...
var AugmentedViewBase =
	...
	(function(_View) {
		...
		_proto.getData = function getData() {
			...
			var data = this.store.getData();
			if (this.sealed || this.immutable || this.store.sealed) data = _objectSpread({}, data);
